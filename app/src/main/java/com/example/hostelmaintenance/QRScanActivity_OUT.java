...
public class QRScanActivity_OUT extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result result) {
        ...
        Intent i = new Intent(this, GatePassVerification_OUT.class);
