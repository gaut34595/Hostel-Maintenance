...
public class PrincipalProcessedVerification extends AppCompatActivity implements LeaveVerifyAdapter.OnLeaveListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_processed_verification);
        ...
        int num = 1;
        int num2 =0;
        recyclerView3 = findViewById(R.id.recyclercheck5);
        ...
        dr.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                FirebaseFirestore.getInstance().collection("Student_Leaves").whereEqualTo("Verified_HOD",num).whereEqualTo("Verified_HW",num2)
                        .whereEqualTo("Student_College",college).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            @Override
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                if(queryDocumentSnapshots.size()!=0) {
                                    for (DocumentChange ds : queryDocumentSnapshots.getDocumentChanges()) {
                                        ...
                                        leaveGrantAdapter = new LeaveVerifyAdapter(getApplicationContext(), grantlist, PrincipalProcessedVerification.this);
                                    ...
                                    if (progressDialog.isShowing()) {
                                        progressDialog.dismiss();
                                        Toast.makeText(PrincipalProcessedVerification.this, "No Data Found", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            public void onFailure(@NonNull Exception e) {
                                if(progressDialog.isShowing()){
                                    progressDialog.dismiss();
                                    Toast.makeText(PrincipalProcessedVerification.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
